...
class UFLDv2:
    def __init__(self, engine_path, config_path, ori_size):
        ...
        for i in range(self.engine.num_io_tensors):
            ...
            # This line is mandatory in TensorRT 10:
...
def get_args():
    ...
    parser.add_argument('--config_path', default='./LaneDetector/configs/culane_res34.py', help='path to config file', type=str)
    parser.add_argument('--engine_path', default='./models/lane/culane_res34.engine',
                        help='path to engine file', type=str)
    parser.add_argument('--video_path', default='./RawVideos/Resize/ลงทางด่วนไปซีคอน.mp4', help='path to video file', type=str)
